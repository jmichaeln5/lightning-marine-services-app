...
class PurchasersTest < ApplicationSystemTestCase
  ...
  test "creating a Purchaser" do
    ...
    fill_in "Date delivered", with: @purchaser.date_delivered
    fill_in "Date recieved", with: @purchaser.date_recieved
    fill_in "Distributed by", with: @purchaser.distributed_by
    fill_in "Name", with: @purchaser.name
    fill_in "Po number", with: @purchaser.po_number
